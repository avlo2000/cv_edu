...
def calc_path(wp0: Waypoint2d, wp1: Waypoint2d) -> Poly5Path:
    ...
    mat = np.array([
        [wp0.x**5, wp0.x**4, wp0.x**3, wp0.x**2, wp0.x, 1],
        [wp1.x**5, wp1.x**4, wp1.x**3, wp1.x**2, wp1.x, 1],
        [5*wp0.x**4, 4 * wp0.x**3, 3*wp0.x**2, 2*wp0.x, 1, 0],
        [5*wp1.x**4, 4 * wp1.x**3, 3*wp1.x**2, 2*wp1.x, 1, 0],
        [20*wp0.x**3, 12 * wp0.x**2, 6*wp0.x, 2, 0, 0],
        [20*wp1.x**3, 12 * wp1.x**2, 6*wp1.x, 2, 0, 0],
    ])
    curv = 0.0000001
    b = np.array([wp0.y, wp1.y, der0, der1, curv, curv])
