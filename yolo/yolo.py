...
def YoloV2(size=None, channels=3, anchors=yolo_anchors, masks=yolo_anchor_masks, classes=80, training=False):
...
yolo = YoloV2(classes=80)
yolo.summary()
load_darknet_weights(yolo, 'data/yolov2.weights', False)
