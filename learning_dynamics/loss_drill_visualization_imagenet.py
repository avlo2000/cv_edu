...
def main():
    ...
    trained_model = models.efficientnet_b0(weights=weights).to(DEVICE)
    # stupid_model = models.efficientnet_b0().to(DEVICE)
    over_fitted_model = torch.load('../transfer_learning/assets/EfficientNet_B0_ImageWoof.pkl')
    ...
    weights, losses = loss_drill(trained_model, over_fitted_model, nn.CrossEntropyLoss(),
